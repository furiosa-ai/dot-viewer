...
impl View {
    ...
    pub(crate) fn goto(&mut self, id: &str) -> Res {
    ...
    pub(crate) fn filter(&mut self, prefix: &str) -> Result<View, DotViewerError> {
    ...
    pub(crate) fn subgraph(&mut self) -> Result<View, DotViewerError> {
    ...
    pub(crate) fn update_adjacent(&mut self) -> Result<(), DotViewerError> {
